...
{
    uint32_t dwError = 0;
    TDNF_METALINK_URL_LIST *urlList = NULL;
    TDNF_METALINK_URL *urlInfo = NULL;
...
cleanup:
    ...
    if (ml_ctx)
    {
        TDNF_SAFE_FREE_METALINK_CTX_MEMORY(ml_ctx);
    }
    return dwError;
